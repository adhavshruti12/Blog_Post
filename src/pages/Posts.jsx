...
function Posts() {
  ...
  useEffect(() => {
    ...
    const fetchPosts = async () => {
      try {
        const response = await axios.get('https://blog-post-backend-nu.vercel.app/api/posts');
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this post?')) {
      try {
        await axios.delete(`https://blog-post-backend-nu.vercel.app/api/post/${id}`);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`https://blog-post-backend-nu.vercel.app/api/post/${editingPost._id}`, updatedData);
